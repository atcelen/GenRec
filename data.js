    ...
    benchmarks: [
      {
        ...
        rows: [
          ...
          { method: "GenRec", ours: true, values: ["17.05", "0.6071", "0.3220", "33.09", "20.85", "0.6738", "14.18", "0.4743", "~11s"] }
        ]
      },
      {
        id: "dl3dv",
        ...
        rows: [
          ...
          { method: "GenRec", ours: true, values: ["19.80", "0.6195", "0.2188", "32.36", "21.35", "0.6605", "16.66", "0.4983", "~11s"] }
        ]
      },
      {
        id: "mipnerf",
        ...
        rows: [
          ...
          { method: "GenRec", ours: true, values: ["13.10", "0.2478", "0.4895", "139.4", "15.37", "0.2858", "12.16", "0.2200", "~11s"] }
        ]
      },
      {
        id: "interp",
        ...
        rows: [
          ...
          { method: "GenRec", ours: true, values: ["19.80", "0.7043", "0.2205", "21.99", "0.7009", "0.1558"] }
        ]
      }
    ]
  };
    ...
    datasets: [
      {
        ...
        rows: [
          ...
          { method: "+ Reconstruction Branch", ours: true, values: ["17.05", "0.6071", "0.3220", "33.09", "20.85", "0.6738"] }
        ]
      },
      {
        label: "DL3DV-10K",
